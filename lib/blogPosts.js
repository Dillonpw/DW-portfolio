...
{ type: "spring", damping: 12, delay: 1.9 }
        ...
        <section className="px-8">
          ...
          <p>
            ...
            and animations are component-scoped. You can see how simple it is to
            add. Hopefully, you found this useful! It can simplify the process
            of adding animations to your project. Go give it a try and see how
            it works for you!
          </p>
        </section>
      </article>
