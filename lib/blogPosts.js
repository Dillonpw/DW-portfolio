...
export const allPosts = [
  {
    ...
    content: (
      <article className="flex flex-col gap-6 mx-10">
        <section className="px-8">
          ...
          <p>
            ...
            technologies I have experience with. Sure, I&apos;m more proficient
            in some than others, but this way I don&apos;t have to rank or weigh my
            skills.
          </p>
        </section>
        <section className="px-8">
        ...
        <section className="px-8 space-y-4">
          ...
          animation we add to the Tailwind config file. <br/>
            ...
            settings to get the pace or even the direction you want. So go give
